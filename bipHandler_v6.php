...
$file="appony.log";
$log=date("Y-m-d h:i:sa")." - sender: ".$sender." keyword: ".$keyword." - msgid:".$msgId.PHP_EOL; 
...
//echo "\nAppcontrol array printR: ".$appCresult;
//print_r($applist);
echo "\napplist: ";
print_r($applist);
$receiver=$sender;
...
$file="appony.log";
$log=date("Y-m-d h:i:sa")." - RESPONSE - receiver: ".$sender." jsonString: ".$postresult." - msgid:".$msgId.PHP_EOL; 
