...
echo "STARTED</br>";
											...
											$yesterdayMinusTwoRating=getAndroidRatingMinusTwo($appName);
													if ($yesterdayMinusOneRating!='' && $yesterdayMinusTwoRating!=''){
															...
															$informText=$informText." \n".$appName." dun:".$yesterdayMinusTwoRating." bugun: ".$yesterdayMinusOneRating;
															}
...
$file="appony.log";
$log=date("Y-m-d h:i:sa")." - DAILY REPORT HAS BEEN SENT content: ".$$inform.$informText." result: ".$logger;
